/*
Purpose: Generate Table 4 - Democratizations and revolution/democratic CSO activity
Author: Max Miller
Date: 12-11-2025
*/
...
global IND_VARS combo_dem_minus_start interact_rev interact_dem rev_cso dem_cso
...
save_estimate, key("column1.pe") value(`=_b[combo_dem_minus_start]') file("table4")
save_estimate, key("column1.se") value(`=_se[combo_dem_minus_start]') file("table4")
...
estadd local controls "No" , replace
save_estimate, key("column2.pe") value(`=_b[combo_dem_minus_start]') file("table4")
save_estimate, key("column2.se") value(`=_se[combo_dem_minus_start]') file("table4")
sum combo_dem_minus_start if combo_dem_minus_start == 1 & e(sample) == 1
estadd local demSamp  `r(N)', replace
...
estadd local econtrols "Yes" , replace
estadd local controls "No" , replace
save_estimate, key("column3.pe") value(`=_b[combo_dem_minus_start]') file("table4")
save_estimate, key("column3.se") value(`=_se[combo_dem_minus_start]') file("table4")
sum combo_dem_minus_start if combo_dem_minus_start == 1 & e(sample) == 1
estadd local demSamp  `r(N)', replace
...
estadd local econtrols "Yes" , replace
estadd local controls "No" , replace
save_estimate, key("column4.pe") value(`=_b[combo_dem_minus_start]') file("table4")
save_estimate, key("column4.se") value(`=_se[combo_dem_minus_start]') file("table4")
sum combo_dem_minus_start if combo_dem_minus_start == 1 & e(sample) == 1
estadd local demSamp  `r(N)', replace
...
estadd local econtrols "Yes" , replace
estadd local controls "No" , replace
save_estimate, key("column5.pe") value(`=_b[combo_dem_minus_start]') file("table4")
save_estimate, key("column5.se") value(`=_se[combo_dem_minus_start]') file("table4")
sum combo_dem_minus_start if combo_dem_minus_start == 1 & e(sample) == 1
estadd local demSamp  `r(N)', replace
...
estadd local econtrols "Yes" , replace
estadd local controls "No" , replace
save_estimate, key("column6.pe") value(`=_b[combo_dem_minus_start]') file("table4")
save_estimate, key("column6.se") value(`=_se[combo_dem_minus_start]') file("table4")
sum combo_dem_minus_start if combo_dem_minus_start == 1 & e(sample) == 1
estadd local demSamp  `r(N)', replace

# delimit ;

esttab using "${TABLES}/table_4_revolution_risk.tex", 
	transform(@*100 100) b(%9.2f) se(%9.2f) 
	drop(_cons $EC $CC rev_cso dem_cso) 
	s(country_fe date_fe reg_year cont_reg_year econtrols controls demSamp r2 N, 
		label("Country FE" "Year FE" "Region $\times$ Year FE" 
			"Continent $\times$ Regime $\times$ Year FE" "Event Controls" 
			"Other Controls" "Episode obs." "R$^2$" "Observations") 
